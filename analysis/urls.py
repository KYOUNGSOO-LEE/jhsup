...
urlpatterns = [
    ...
    url(r'^ajax/load_major_group$', views.load_major_group, name="ajax_load_major_group"),
    url(r'^ajax/load_univ_region$', views.load_univ_region, name="ajax_load_univ_region"),
